...
!(function () {
  ...
  function e(e, t) {
      if (e) {
          if (t.element_.classList.contains(t.CssClasses_.m_JS_RIPPLE_EFFECT)) {
              var s = document.createElement("span");
              s.classList.add(t.CssClasses_.m_RIPPLE_CONTAINER), s.classList.add(t.CssClasses_.m_JS_RIPPLE_EFFECT);
              var i = document.createElement("span");
              i.classList.add(t.CssClasses_.m_RIPPLE), s.appendChild(i), e.appendChild(s);
          }
  ...
  (s = (function () {
      ...
      function o(t) {
          ...
          if (
              ...
              throw new Error("m component classes must not have " + C + " defined as a property.");
      ...
      function h(e) {
          ...
          if (e instanceof Array || e instanceof NodeList) for (var s = 0; s < e.length; s++) t(e[s]);
              ...
              if (!(e instanceof Node)) throw new Error("Invalid argument provided to downgrade m nodes.");
              t(e);
          }
      }
      var c = [],
          p = [],
          C = "mComponentConfigInternal_";
  ...
  (window.MaterialCheckbox = r),
      ...
      (r.prototype.CssClasses_ = {
          ...
          BOX_OUTLINE: "m-checkbox__box-outline",
          FOCUS_HELPER: "m-checkbox__focus-helper",
          TICK_OUTLINE: "m-checkbox__tick-outline",
          RIPPLE_EFFECT: "m-js-ripple-effect",
          RIPPLE_IGNORE_EVENTS: "m-js-ripple-effect--ignore-events",
          RIPPLE_CONTAINER: "m-checkbox__ripple-container",
      ...
      s.register({ constructor: r, classAsString: "MaterialCheckbox", cssClass: "m-js-checkbox", widget: !0 });
  var _ = function (e) {
      (this.element_ = e), this.init();
  };
  ...
  (window.MaterialRadio = c),
      ...
      (c.prototype.CssClasses_ = {
          ...
          IS_UPGRADED: "is-upgraded",
          JS_RADIO: "m-js-radio",
          RADIO_BTN: "m-radio__button",
          RADIO_OUTER_CIRCLE: "m-radio__outer-circle",
          RADIO_INNER_CIRCLE: "m-radio__inner-circle",
          RIPPLE_EFFECT: "m-js-ripple-effect",
          RIPPLE_IGNORE_EVENTS: "m-js-ripple-effect--ignore-events",
          RIPPLE_CONTAINER: "m-radio__ripple-container",
          RIPPLE_CENTER: "m-ripple--center",
          RIPPLE: "m-ripple",
      }),
      ...
      s.register({ constructor: c, classAsString: "MaterialRadio", cssClass: "m-js-radio", widget: !0 });
  var p = function (e) {
  ...
  (window.MaterialSwitch = E),
      ...
      (E.prototype.CssClasses_ = {
          INPUT: "m-switch__input",
          TRACK: "m-switch__track",
          THUMB: "m-switch__thumb",
          FOCUS_HELPER: "m-switch__focus-helper",
          RIPPLE_EFFECT: "m-js-ripple-effect",
          RIPPLE_IGNORE_EVENTS: "m-js-ripple-effect--ignore-events",
          RIPPLE_CONTAINER: "m-switch__ripple-container",
          RIPPLE_CENTER: "m-ripple--center",
          RIPPLE: "m-ripple",
          IS_FOCUSED: "is-focused",
          IS_DISABLED: "is-disabled",
      ...
      s.register({ constructor: E, classAsString: "MaterialSwitch", cssClass: "m-js-switch", widget: !0 });
  var m = function (e) {
      (this.element_ = e), this.init();
  };
  ...
  (window.MaterialDataTable = b),
      ...
      (b.prototype.CssClasses_ = { DATA_TABLE: "m-data-table", SELECTABLE: "m-data-table--selectable", SELECT_ELEMENT: "m-data-table__select", IS_SELECTED: "is-selected", IS_UPGRADED: "is-upgraded" }),
      (b.prototype.selectRow_ = function (e, t, s) {
          return t
              ...
              ? function () {
                    var t, i;
                    if (e.checked) for (t = 0; t < s.length; t++) (i = s[t].querySelector("td").querySelector(".m-checkbox")), i.MaterialCheckbox.check(), s[t].classList.add(this.CssClasses_.IS_SELECTED);
                    else for (t = 0; t < s.length; t++) (i = s[t].querySelector("td").querySelector(".m-checkbox")), i.MaterialCheckbox.uncheck(), s[t].classList.remove(this.CssClasses_.IS_SELECTED);
                }.bind(this)
              : void 0;
      }),
      (b.prototype.createCheckbox_ = function (e, t) {
          var i = document.createElement("label"),
              n = ["m-checkbox", "m-js-checkbox", "m-js-ripple-effect", this.CssClasses_.SELECT_ELEMENT];
          i.className = n.join(" ");
          var a = document.createElement("input");
          return (
              (a.type = "checkbox"),
              a.classList.add("m-checkbox__input"),
      ...
      s.register({ constructor: b, classAsString: "MaterialDataTable", cssClass: "m-js-data-table" });
  var S = function (e) {
      (this.element_ = e), this.init();
  };
